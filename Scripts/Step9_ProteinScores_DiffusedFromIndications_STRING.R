...
drug_indication = readRDS("Data/Drug_Indication.rds")
...
#Physical PPI
PPI = read.csv("Data/ProcessedData/Final_Network/PPI_entrez_PhysicalPPI.csv")
#PPI = read.csv("Data/PPI_enrez.csv")
